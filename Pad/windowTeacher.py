...
class teacherWindow(window):
    ...
    def __init__(self, width=1920, height=1200):
        ...
        #表格区域
        emptyGround=self.emptyGround()
        wholeLayout.addWidget(emptyGround)
    ...
    def studentImgGround(self):
        background = QWidget()
        background.setFixedHeight(600)
        background.setFixedWidth(700)
        ...
        perimg = QWidget()
        perimg.setFixedHeight(500)
        perimg.setFixedWidth(400)
    ...
    def studentDataGround(self):
        def wordSet(lable):
            ...
            lable.setFont(QFont("微软雅黑", 10, QFont.Bold))
    ...
    def emptyGround(self):
        emptyWidget=QWidget()
        emptyWidget.setFixedWidth(250)
        emptyWidget.setStyleSheet('QWidget{border-image:url(./teacherimg/分隔.png);}')
        return emptyWidget
    ...
    def tableGround(self):
        ...
        self.prevButton.setFixedHeight(40)
        self.prevButton.setFixedWidth(130)
