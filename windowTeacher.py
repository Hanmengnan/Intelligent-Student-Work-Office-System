...
class teacherWindow(window):
    ...
    def studentImgGround(self):
        ...
        self.perimg = QWidget()
        self.perimg.setFixedHeight(700)
        self.perimg.setFixedWidth(600)
    ...
    def tableGround(self):
        ...
        self.prevButton.setFixedWidth(160)
        ...
        self.backButton.setFixedWidth(160)
